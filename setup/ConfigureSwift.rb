module Pod
  ...
  class ConfigureSwift
    ...
    def perform
      ...
      test_framework = configurator.ask_with_answers("Which testing frameworks will you use", ["None", "Quick"]).to_sym
      case test_framework
        when :quick
      ...
      snapshots = configurator.ask_with_answers("Would you like to do view based testing (FBSnapshotTestCase or Nimble-Snapshots)", ["No", "Yes"]).to_sym
      case snapshots
        when :yes
